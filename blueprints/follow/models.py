...
class Follow(db.Model):
    ...
    follower = db.relationship('User', foreign_keys=[follower_clerkId], backref='following_relationships')
    followed = db.relationship('User', foreign_keys=[followed_clerkId], backref='follower_relationships')
